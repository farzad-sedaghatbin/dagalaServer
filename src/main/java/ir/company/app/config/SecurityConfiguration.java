...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/1/clientTrips").permitAll()
            .antMatchers("/api/1/driverTrips").permitAll()
            .antMatchers("/api/1/endOfTrip").permitAll()
            .antMatchers("/api/1/confirmRequest").permitAll()
            .antMatchers("/api/1/confirmReserve").permitAll()
            .antMatchers("/api/1/approvedDriver").permitAll()
            .antMatchers("/api/1/rejectUser").permitAll()
            .antMatchers("/api/1/refreshMoney").permitAll()
            .antMatchers("/api/1/unavailable").permitAll()
            .antMatchers("/api/1/rejectBeforeDriver").permitAll()
            .antMatchers("/api/1/rejectAfterDriver").permitAll()
            .antMatchers("/api/1/searchForDriver").permitAll()
            .antMatchers("/api/1/Request").permitAll()
            .antMatchers("/api/1/endOfTrip").permitAll()
            .antMatchers("/api/1/detail").permitAll()
            .antMatchers("/api/1/rejectDriver").permitAll()
